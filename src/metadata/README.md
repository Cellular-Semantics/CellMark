 ...
 * [clm.yml](clm.yml)
     * Determines how your purl.obolibrary.org/obo/clm/ redirects will be handled
     ...
     * Paste in the contents of [clm.yml](clm.yml)
 ...
 * [clm.md](clm.md)
     ...
     * Paste in the contents of [clm.md](clm.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
